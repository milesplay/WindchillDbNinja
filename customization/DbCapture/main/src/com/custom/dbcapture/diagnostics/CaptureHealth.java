...
public final class CaptureHealth {
   ...
   public enum Tone { GREEN, YELLOW, RED }
      ...
      public static final class Assessment implements Serializable {
            ...
            public Assessment(Tone tone, String label, String summary, String explanation) {
                  this.tone = tone;
                  this.label = label;
            ...
            public boolean equals(Object other) {
                  ...
                  Assessment that = (Assessment) other;
                  return tone == that.tone && Objects.equals(label, that.label)
                              && Objects.equals(summary, that.summary) && Objects.equals(explanation, that.explanation);
            }

            @Override
            public int hashCode() { return Objects.hash(tone, label, summary, explanation); }

            @Override
            public String toString() {
                  return "Assessment[tone=" + tone + ", label=" + label + ", summary=" + summary
