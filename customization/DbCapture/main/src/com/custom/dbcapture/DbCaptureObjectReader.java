...
public final class DbCaptureObjectReader {
   ...
   public static final class ChangedValue implements java.io.Serializable {
      ...
      public ChangedValue(String column, String before, String after, boolean truncated) {
         this.column = column;
         this.before = before;
         this.after = after;
      ...
      public boolean equals(Object other) {
         ...
         if (!(other instanceof ChangedValue)) return false;
         ChangedValue that = (ChangedValue) other;
         return truncated == that.truncated && Objects.equals(column, that.column)
               && Objects.equals(before, that.before) && Objects.equals(after, that.after);
      }

      @Override
      public int hashCode() { return Objects.hash(column, before, after, truncated); }
   }
   ...
   public static final class Snapshot implements java.io.Serializable {
      ...
      private final Timestamp readAt;
      private final List<String> columns;
      private final List<List<String>> rows;
      private final boolean truncated;
      private final String operation;
      private final List<ChangedValue> changes;

      public Snapshot(String table, long rowId, String reference, Timestamp readAt,
      ...
      public Timestamp readAt() { return readAt; }
      public List<String> columns() { return columns; }
      public List<List<String>> rows() { return rows; }
      public boolean truncated() { return truncated; }
      public String operation() { return operation; }
      public List<ChangedValue> changes() { return changes; }
      ...
      public boolean equals(Object other) {
         ...
         return rowId == that.rowId && truncated == that.truncated && Objects.equals(table, that.table)
               && Objects.equals(reference, that.reference) && Objects.equals(readAt, that.readAt)
               && Objects.equals(columns, that.columns) && Objects.equals(rows, that.rows)
               && Objects.equals(operation, that.operation) && Objects.equals(changes, that.changes);
      }

      @Override
      public int hashCode() {
         return Objects.hash(table, rowId, reference, readAt, columns, rows, truncated, operation, changes);
      }
   }
