...
public class IdentityResolver {
   ...
   public static final class Names {
      ...
      public Names(String name, String number) {
         this.name = name;
         this.number = number;
      }
      ...
      public boolean equals(Object other) {
         ...
         if (!(other instanceof Names)) return false;
         Names that = (Names) other;
      ...
      @Override
      public String toString() { return "Names[name=" + name + ", number=" + number + "]"; }
   }
