...
import com.ptc.dbcapture.engine.CaptureResult;
import com.ptc.dbcapture.engine.CapturedChange;
import com.ptc.dbcapture.engine.CaptureConcurrency;
import com.ptc.dbcapture.engine.MonitoringScope;
import com.ptc.dbcapture.engine.SqlLogWindow;
...
public class StandardDbCaptureService extends StandardManager implements DbCaptureService {
   ...
   private static final String CORRELATE_PROPERTY = "com.ptc.dbcapture.correlateLogs";
   ...
   public DbCaptureBannerState getBannerState() throws WTException {
      ...
      return new DbCaptureBannerState(active != null,
            active == null ? null : active.getCaptureId(),
            active == null ? null : active.getStartedBy(),
            active == null || active.getStartTime() == null ? 0L : active.getStartTime().getTime(),
            administrator,
            active != null && currentUser.equals(active.getStartedBy()));
   }
